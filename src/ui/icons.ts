 ...
 * `setIcon` builds the elements itself, so the plugin never parses a markup
 * string to draw one, and the glyphs then match the rest of the app, including
 * under community themes that restyle the icon set.
 */
export const ICON = {
