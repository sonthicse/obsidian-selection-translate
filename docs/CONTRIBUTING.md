...
| **`npm run verify`** | **Chạy cả bốn. Phải xanh trước khi mở PR.** |
...
Dùng [issue template](https://github.com/sonthicse/selection-translate/issues/new/choose). Kèm log console (bật *Ghi log gỡ lỗi*) sẽ giúp ích rất nhiều.
